...
public class BinarySearchTree<E extends Comparable<E>> { //implements Iterable<E> {
    ...
    private StringBuilder strHelp(Node<E> curr, StringBuilder accum) {
        if (curr == null) {
            return accum;
        }    
        accum = strHelp(curr.left, accum);
        if (curr.item != null) {
            accum.append(curr.item + ", ");
        }
        accum = strHelp(curr.right, accum);
        return accum;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("To String: " + nums);
    }
}
